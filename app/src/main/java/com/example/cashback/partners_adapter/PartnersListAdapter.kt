package az.expressbank.e24.adapters.partners_adapter
...
class PartnersListAdapter(private val partnersSubItems:List<PartnersSubFragmentModel>) : RecyclerView.Adapter<PartnersListAdapter.ViewHolder>() {
    class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        ...
        private val image: TextView = itemView.findViewById(R.id.subItemList_image)
